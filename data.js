...
const POOL = [
  { clipId: "mc01", title: "01", prompt: "An **acoustic piano** is playing a sad sounding composition while someone is playing a **synthesizer** lead-sound that sounds like someone crying. You can hear a lot of **white noise** in the recording. This seems to be an **amateur recording**. This song may be playing on a TV show.", promptZh: "原聲鋼琴演奏一首聽起來悲傷 (sad) 的樂曲，同時有人用 synthesizer lead 奏出類似有人在哭的聲音。錄音中有很多白噪。聽起來像業餘錄音。這首歌可能會在電視節目中播放。", files: { p7v1: "mc01_p7v1.wav", p8v1: "mc01_p8v1.wav" } },
  { clipId: "mc02", title: "02", prompt: "This song contains **digital drums** playing a groove that invites to dance along with some percussive sounds. A **bass hit** sounds is adding rhythmic and harmonic elements along with a short **synth lead** sound in the higher register. A **male voice** is shouting/singing with delay on his voice. This song may be playing in a club.", promptZh: "這首歌有電子鼓演奏一段令人想跟著跳舞的 groove，搭配一些打擊樂音效。bass 打擊聲加入節奏與和聲元素，配上高音域短促的 synth lead。男聲邊喊邊唱，人聲帶有 delay。這首歌可能會在俱樂部播放。", files: { p7v1: "mc02_p7v1.wav", p8v1: "mc02_p8v1.wav" } },
  { clipId: "mc03", title: "03", prompt: "The **low quality** recording features an in-game audio recording that features an echoing female exhale sound, shimmering **hi hats**, claps, shimmering **bells melody** and groovy **bass guitar**. In the second half of the loop, the song changes and there is a sweet **female vocal** humming a melody. It sounds exciting, happy and fun.", promptZh: "低音質錄音呈現遊戲內音效，包含帶迴響的女性呼氣聲、閃亮的 hi-hat、拍手聲、閃亮的 bells 旋律與 groovy 的 bass guitar。loop 後半曲風轉變，出現甜美 (sweet) 的女聲哼唱旋律。聽起來興奮 (exciting)、快樂 (happy)、有趣 (fun)。", files: { p7v1: "mc03_p7v1.wav", p8v1: "mc03_p8v1.wav" } },
  { clipId: "mc04", title: "04", prompt: "A **male singer** sings this emotional melody with a **female backup singer** singing chanting tones. The song is **slow tempo** with a **guitar** strumming gently and no other instrumentation. The song is emotional and romantic. The song is beautiful and lilting.", promptZh: "男歌手演唱這段情感豐富 (emotional) 的旋律，女伴唱以吟唱 (chanting) 音調配合。慢速，只有吉他輕柔刷奏，無其他樂器。整首情感豐富 (emotional) 且浪漫 (romantic)，優美輕快 (beautiful and lilting)。", files: { p7v1: "mc04_p7v1.wav", p8v1: "mc04_p8v1.wav" } },
  { clipId: "mc05", title: "05", prompt: "The excerpt starts off with 3 **bass drum** beats after which an **explosion** and a crumbling sound can be heard. After this, downward sliding **strings** or a similar instrument in timbre can be heard creating a sort of scary effect. In the background **wind sounds** can be heard throughout.", promptZh: "片段以 3 次 bass drum 敲擊開始，接著是爆炸聲與崩塌聲。之後出現向下滑音的弦樂（或音色類似的樂器），營造恐怖 (scary) 感。背景全程有風聲。", files: { p7v1: "mc05_p7v1.wav", p8v1: "mc05_p8v1.wav" } },
  { clipId: "mc06", title: "06", prompt: "The **Pop** song features an echoing **synth keys** melody that consists of a passionate **female vocal** singing over **punchy kick**, synth bells melody, echoing synth keys melody and shimmering hi hats. It sounds emotional and passionate.", promptZh: "這首流行 (Pop) 歌曲以帶迴響的 synth keys 旋律為主，女聲充滿熱情地在 punchy kick、synth bells 旋律、帶迴響的 synth keys 與閃亮 hi-hat 之上演唱。聽起來情感豐富 (emotional) 且熱情 (passionate)。", files: { p7v1: "mc06_p7v1.wav", p8v1: "mc06_p8v1.wav" } },
  ...
  { clipId: "mc17", title: "17", prompt: "The **low quality** recording features a musician practicing **bassoon** scale. In the background, there is a muffled **male vocal**. The recording is **mono** and **noisy**.", promptZh: "低音質錄音呈現一位樂手在練 bassoon（巴松管）音階。背景有模糊的男聲。錄音為單聲道 (mono) 且有雜訊。", files: { p7v1: "mc17_p7v1.wav", p8v1: "mc17_p8v1.wav" } },
